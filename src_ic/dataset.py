...
class Dataset:
    ...
    def __init__(self, option=None):
        ...
        self.kg, self.id2entity, self.entity2id, self.id2relation, self.relation2id, self.train_kg_ori, \
                self.train_kg_inv, self.triple2id, self.id2triple = self.load_kg_all(self.option.data_dir)
    ...
    def load_kg_all(self, kg_path):
        ...
        return kg, id2entity, entity2id, id2relation, relation2id, train_triples_ori, train_triples_inv, triple2id, id2triple
