...
skip_list=("di_edge_0" "di_edge_1" "di_edge_2" "di_edge_3" "di_edge_4" "di_edge_5" "di_edge_6" "di_edge_7")
...
$python -u main.py \
        ...
        --allowed_predicates "di_edge_0,di_edge_1,di_edge_2,di_edge_3,di_edge_4,di_edge_5,di_edge_6,di_edge_7" \
        --no_recursive_rules \
        --negative_sampling \
